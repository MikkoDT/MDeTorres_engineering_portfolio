...
% -------- edition switch
% portfolio.tex         -> full portfolio
% portfolio_design.tex  -> short mechanical design edition (sets \designedition)
\newif\ifdesign
\ifdefined\designedition \designtrue \fi
...
%                              CONTENT
% =====================================================================
% -------- contact details (edit here, used on the cover and closing page)
\newcommand{\cemail}{\href{mailto:mikkodtorres@gmail.com}{mikkodtorres@gmail.com}}
\newcommand{\cphone}{\href{tel:+639568517289}{+63 956 851 7289}}
\newcommand{\csite}{\href{https://mikkodt.github.io/MikkoDT_Portfolio}{mikkodt.github.io/MikkoDT\_Portfolio}}
\newcommand{\clinkedin}{\href{https://linkedin.com/in/mikko-de-torres}{linkedin.com/in/mikko-de-torres}}
\newcommand{\cgithub}{\href{https://github.com/MikkoDT}{github.com/MikkoDT}}
\newcommand{\cyoutube}{\href{https://www.youtube.com/@mikkodetorres}{youtube.com/@mikkodetorres}}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north west,text=white!78!deep,font=\fontsize{13}{16}\selectfont,align=left]
    ...
    {\ifdesign Mechanical design and automation engineer\else Mechatronics, robotics and AI engineer\fi};
  \node[anchor=north west,text=white!62!deep,font=\sffamily\fontsize{10}{13}\selectfont,align=left]
    ...
    {\ifdesign SolidWorks \quad Mechanisms \quad Fabrication drawings \quad 3D printing \quad Robotics\else
     Mechanical design \quad CAD \quad 3D printing \quad Robotics \quad Machine learning\fi};
  ...
  \node[anchor=south west,text=white!62!deep,font=\sffamily\fontsize{8.6}{12}\selectfont,align=left]
    ...
    {\cemail \quad\textbar\quad \cphone \quad\textbar\quad Bauan, Batangas\\[1.4mm]
     \csite \quad\textbar\quad \clinkedin \quad\textbar\quad \cgithub \quad\textbar\quad \cyoutube};
\end{tikzpicture}
\clearpage
...
\ifdesign
  {\sffamily\bfseries\fontsize{18}{22}\selectfont\color{deep}
   Mechanical design, from concept to a working machine\par}
  \vspace{4mm}

  I design mechanisms and machines in SolidWorks, then build and test them. My work
  covers the concept, 3D models, drawings, part selection, assembly and testing.

  \vspace{2.5mm}
  Seven years in industry as a maintenance and automation engineer, then seven teaching
  robotics, control systems and machine design at Batangas State University.

  \vspace{5mm}
  {\sffamily\bfseries\small\color{deep}What I bring to a team\par}
  \vspace{1.5mm}
  Design it, choose the parts, build it, test it, then document it well enough that
  someone else can build it again.
  ...
  DOST-funded solar power station, from fabrication drawings to a deployed unit.
  Designed the joint drives of a SCARA arm: chain and sprocket, belt and pulley, rack
  and pinion, and a screw-driven gripper.

  \vspace{4mm}
  {\sffamily\bfseries\small\color{deep}Electronics and code\par}
  \vspace{1.5mm}
  Arduino, ESP32, stepper and servo motors, ROS, Python, MATLAB. I can wire and program
  what I design.
...
\fi
  ...
  \vspace{4mm}
  {\sffamily\bfseries\small\color{deep}Certifications\par}
  \vspace{1.5mm}
  TESDA NC II, Mechatronics Servicing.\\
  BOSH Safety Officer 2 (SO2), 2026.
\end{minipage}
\clearpage
...
Linear actuators open and close the panel array.}
...
and SCARA manipulator types, plus a 6-DOF SCARA V3 (a 3-DOF SCARA with a spherical
wrist), each covering kinematics, dynamics
...
% -------- 3-DOF RRP SCARA MANIPULATOR
\bleedband{images/scara/parts.jpg}{65mm}
          {[ SCARA parts before assembly ]}
\vspace{-20mm}

\projecttitle{3-DOF RRP SCARA manipulator}
             {A SCARA-type arm with two rotary joints and a vertical slide. I designed
              the machine elements and programmed the robot.}

\vspace{2mm}
\noindent\begin{minipage}[t]{0.18\linewidth}
  \begin{minipage}[t][40mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=40mm,keepaspectratio]{images/scara/cad-iso.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}3D model\par}
\end{minipage}%
\hspace{0.03\linewidth}%
\begin{minipage}[t]{0.27\linewidth}
  \begin{minipage}[t][40mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=40mm,keepaspectratio]{images/scara/cad-top.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Top view - reach\par}
\end{minipage}%
\hspace{0.03\linewidth}%
\begin{minipage}[t]{0.49\linewidth}
  \begin{minipage}[t][40mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=40mm,keepaspectratio]{images/scara/schematic.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Control circuit\par}
\end{minipage}
\vspace{3mm}

\noindent\begin{minipage}[t]{0.22\linewidth}
  \begin{minipage}[t][29mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=29mm,keepaspectratio]{images/scara/chain.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Chain and sprocket\par}
\end{minipage}%
\hspace{0.04\linewidth}%
\begin{minipage}[t]{0.22\linewidth}
  \begin{minipage}[t][29mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=29mm,keepaspectratio]{images/scara/belt.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Belt and pulley\par}
\end{minipage}%
\hspace{0.04\linewidth}%
\begin{minipage}[t]{0.22\linewidth}
  \begin{minipage}[t][29mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=29mm,keepaspectratio]{images/scara/rack.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Rack and pinion\par}
\end{minipage}%
\hspace{0.04\linewidth}%
\begin{minipage}[t]{0.18\linewidth}
  \begin{minipage}[t][29mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=29mm,keepaspectratio]{images/scara/end-effector.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}End effector\par}
\end{minipage}
\vspace{3mm}

\detail{What I built}{The drive for each joint: a chain and sprocket in the base, a
belt and pulley in the first arm, and a rack and pinion with gear reduction for the
vertical slide. The gripper runs on its own stepper motor.}

\detail{How}{An ESP32 drives four stepper motors. Hall sensors find the home position of
the two rotary joints, limit switches stop the slide and the gripper at their ends, and
a small LCD shows the readings.}

\titleblock{Design and programming}{CAD, ESP32, stepper motors}
...
\bleedband{images/arm-5dof/rigs.jpg}{65mm}
          {[ joint test rigs on the bench ]}
\vspace{-20mm}

\projecttitle{5-DOF articulated manipulator}
             {A five-axis arm run through LinuxCNC. I did the real-time testing and
              the LinuxCNC setup, and helped program it.}

\vspace{2mm}
\noindent\begin{minipage}[t]{0.42\linewidth}
  \begin{minipage}[t][52mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=52mm,keepaspectratio]{images/arm-5dof/cad.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}SolidWorks model\par}
\end{minipage}%
\hspace{0.03\linewidth}%
\begin{minipage}[t]{0.22\linewidth}
  \begin{minipage}[t][52mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=52mm,keepaspectratio]{images/arm-5dof/joint-cad.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Joint test rig - CAD\par}
\end{minipage}%
\hspace{0.03\linewidth}%
\begin{minipage}[t]{0.30\linewidth}
  \begin{minipage}[t][52mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=52mm,keepaspectratio]{images/arm-5dof/dials.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Angle dials on the rigs\par}
\end{minipage}
\vspace{5mm}

\detail{What I built}{Each joint was tested on its own rig, with a motor, an encoder,
the gear set and a printed angle dial. This let us check each joint's angle before it
went on the arm.}

\detail{How}{LinuxCNC sends the joint commands to the motors and to a digital twin of
the arm, so the model and the real joints move together.}

\titleblock{Testing and integration}{LinuxCNC, motors and encoders}
           {Robotics Laboratory}{2024}
\clearpage
...
\projecttitle{Cartesian CNC robot - digital twin}
             {A three-axis Cartesian robot and its digital twin, built with a student
              team at the Mechatronics and Robotics Laboratory.}

\noindent\begin{minipage}[t]{0.48\linewidth}
  \begin{minipage}[t][50mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=50mm,keepaspectratio]{images/capstone-robots/cad2.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}3D model\par}
\end{minipage}%
\hspace{0.04\linewidth}%
\begin{minipage}[t]{0.48\linewidth}
  \begin{minipage}[t][50mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=50mm,keepaspectratio]{images/capstone-robots/flowchart.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Data integration\par}
\end{minipage}
\vspace{4mm}

\noindent\begin{minipage}[t]{0.48\linewidth}
  \begin{minipage}[t][50mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=50mm,keepaspectratio]{images/capstone-robots/front.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Kinematics - front\par}
\end{minipage}%
\hspace{0.04\linewidth}%
\begin{minipage}[t]{0.48\linewidth}
  \begin{minipage}[t][50mm][c]{\linewidth}\centering\includegraphics[width=\linewidth,height=50mm,keepaspectratio]{images/capstone-robots/top.jpg}\end{minipage}
  \par\vspace{1mm}{\raggedright\sffamily\footnotesize\color{steel}Kinematics - top\par}
\end{minipage}
\vspace{3mm}

\detail{What I built}{The geometric design in SolidWorks and the digital twin,
programmed and linked to LinuxCNC. The work covers the kinematics, the data link
between the machine and the model, and the engineering drawings.}

\titleblock{Design and programming}{SolidWorks, LinuxCNC, MATLAB}
           {Robotics Laboratory}{2023}
\clearpage

\ifdesign\else
% -------- TEACHING
\bleedband{images/youtube/main.jpg}{40mm}
          {[ YouTube channel ]}
\vspace{-20mm}
...
\noindent\includegraphics[width=62mm]{images/youtube/channel.jpg}\par\vspace{2mm}

\detail{YouTube - \cyoutube}{Over 130 videos and 1,300 subscribers. I script, film
and edit videos on robotics, data science in Excel, Git and GitHub, and basic workshop
and machining.}
...
\textbf{MexEE402\_AI}  - data science, machine learning and putting models into use.}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north west,text=white!85!deep,font=\sffamily\fontsize{9.4}{15}\selectfont,align=left]
    at ($(current page.north west)+(22mm,-134mm)$)
    {\cemail\\ \cphone\\ \csite\\ \clinkedin\\ \cgithub\\ \cyoutube};
\end{tikzpicture}
